...
import { useForgotPasswordVerify } from "@/query/useForgotPasswordVerify.ts"
import { useForgotPassword } from "@/query/useForgotPassword.ts"
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          maxLength={8}
                          {...field}
                          className="font-pitch-sans-medium text-paragraph focus:bg-white focus:text-black text-center text-lg tracking-widest"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
